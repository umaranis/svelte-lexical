...
/**
 * Readable store that subscribes to the {@link LexicalEditor._editable} state.
 */
export function setIsEditable(editor: LexicalEditor): Readable<boolean> {
  const isEditable = readable(editor.isEditable(), (set) => {
