...
This plugin enables markdown shortcuts for formatting texts and other elements. For instance, `#` followed by space can be used to create a heading.
...
| TABLE                  | Paste the table markdown and it will be converted to a table automatically |
