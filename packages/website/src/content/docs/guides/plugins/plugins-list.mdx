...
| [Code Block (Prism)](code-highlight)    | Enable code blocks (through Prism)                                                                                 | CodeHighlightPrismPlugin         |                                  |
| [Code Block (Shiki)](code-highlight)    | Enable code blocks (through Shiki)                                                                                 | CodeHighlightShikiPlugin         |                                  |
| Code Block Actions                      | Enable `copy` and `prettier` actions for code blocks                                               | CodeActionMenuPlugin             | CodeHighlightPrismPlugin or CodeHighlightShikiPlugin             |
...
| Twitter                                 | Add Twitter/X post support                                                                         | TwitterPlugin                    |                                  |
