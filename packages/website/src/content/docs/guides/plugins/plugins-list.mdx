...
| Code Block                              | Enable code blocks                                                                                 | CodeHighlightPrismPlugin              |                                  |
| Code Block Actions                      | Enable `copy` and `prettier` actions for code blocks                                               | CodeActionMenuPlugin             | CodeHighlightPrismPlugin              |
